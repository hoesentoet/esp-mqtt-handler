...
inline constexpr const char* HaUnitStrings[] PROGMEM = {
    "",     "W",     "kW",    "V",     "Wh",    "kWh",     "A",      "VA",       "°",      "€",
    "$",    "¢",     "°C",    "°F",    "K",     "μs",      "ms",     "s",        "min",    "h",
    "d",    "w",     "m",     "y",     "mm",    "cm",      "m",      "km",       "in",     "ft",
    "yd",   "mi",    "Hz",    "GHz",   "Pa",    "hPa",     "bar",    "mbar",     "inHg",   "psi",
    "L",    "mL",    "m³",    "ft³",   "gal",   "fl. oz.", "m³/h",   "ft³/m",    "m²",     "g",
    "kg",   "mg",    "µg",    "oz",    "lb",    "µS/cm",   "lx",     "UV index", "%",      "W/m²",
    "mm/h", "µg/m³", "mg/m³", "p/m³",  "ppm",   "ppb",     "mm/d",   "in/d",     "m/s",    "in/h",
    "km/h", "mph",   "dB",    "dBm",   "bit",   "kbit",    "Mbit",   "Gbit",     "B",      "kB",
    "MB",   "GB",    "TB",    "PB",    "EB",    "ZB",      "YB",     "KiB",      "MiB",    "GiB",
    "TiB",  "PiB",   "EiB",   "ZiB",   "YiB",   "bit/s",   "kbit/s", "Mbit/s",   "Gbit/s", "B/s",
    "kB/s", "MB/s",  "GB/s",  "KiB/s", "MiB/s", "GiB/s",
};
